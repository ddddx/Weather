...
import com.ddddx.weather.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh.setColorSchemeColors(Color.BLUE, Color.GREEN, Color.BLACK);
...
//        final String weatherId;
        ...
        transition.replace(R.id.choose_area_fragment,new ChooseAreaFragment());
        transition.commit();
    }
    ...
    public void requestWeather(String weatherId) {
        String url = "https://api.heweather.com/v5/weather?city=" + weatherId + "&key=b62d33a4aa774e4cb5e8057a699b7d49";
        HttpUtil.sendOKHttpRequest(url, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final Weather weather = Utility.handleWeatherResponse(text);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
